...
$sql = mysql_query("SELECT * FROM products WHERE product_name='$product_name' OR category='$category_name' OR subcategory='$subcategory_name' ORDER BY date_added DESC LIMIT 6");
    ...
    '.$product_name.'</div>
     <div class="buynow"> KES '.$price.'</div>
      ...
      <a href="product.php?id='.$id.'">View Product</a>
		...
		$dynamicList="<h4 style='color: red;'>We have no such products listed in our store yet. Please search again...</h4>";
		}}
		mysql_close();
?>
