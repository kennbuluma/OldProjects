...
?>
 <?php 
//grabs the whole inventory for viewing
$dynamicList="";
$sql = mysql_query("SELECT * FROM products WHERE qt>0 ORDER BY date_added DESC LIMIT 6");
    ...
    '.$product_name.'</div>
     <div class="buynow"> KES '.$price.'</div>
      ...
      <a href="product.php?id='.$id.'">View Product</a>
		...
		$dynamicList="<h4 style='color: red;'>We have no products listed in our store yet</h4>";
		}
		mysql_close();
?>
