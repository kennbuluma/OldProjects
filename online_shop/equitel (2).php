...
$x='';
$customer ='';
$equitel_checkout_btn="";
if(!isset($_SESSION["cart_array"])|| count($_SESSION["cart_array"])<1){
	$cartOutput="<h2 align='center'>Your shopping cart is empty</h2>";
	}else{
		//start paypal checkout button
		$equitel_checkout_btn .='<form action="equitel.php" method="post">';
...
$sq = mysql_query("INSERT INTO transaction(transaction_id, user, total, Payment_Mode, Payment_Transaction_No, date_added, status, Type) VALUES('$transaction_id','$manager', '$cost1', 'Equitel', '$Payment_Transaction_No', now(), 'Pending', 'Cash')") or die (mysql_error());
...
?>
      ...
      <tr>
        <td><strong>EQUITEL PAYMENT </strong></td>
      </tr>
      <tr>
        <td><img src="pics/equitel.jpg" alt="M-Pesa" width="256" height="145" /></td>
      </tr>
      <tr>
        <td>Purchase your goods via Equitel</td>
      </tr>
      <tr>
        <td>Our Equitel Pay Bill No. is: <strong>BTHM5458543NB </strong></td>
      </tr>
      <tr>
      ...
      <tr>
        <td>Enter Equitel Transaction No Below </td>
      </tr>
      <tr>
