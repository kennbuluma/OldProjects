...
if(!isset($_SESSION["cart_array"])|| count($_SESSION["cart_array"])<1){
	$cartOutput="<h2 align='center'>Your shopping cart is empty</h2>";
		...
		$mpesa_checkout_btn .='<form action="mpesa.php" method="post">';	
		//start for each loop
		$i=0;
...
$sq = mysql_query("INSERT INTO transaction(transaction_id, user, total, Payment_Mode, Payment_Transaction_No, date_added, status, Type) VALUES('$transaction_id','$manager', '$cost1', 'M-Pesa', '$Payment_Transaction_No', now(), 'Pending', 'Cash')") or die (mysql_error());
...
?>
      ...
      <tr>
        <td><strong>M-PESA PAYMENT </strong></td>
      </tr>
      <tr>
        <td><img src="pics/mpesa.jpg" alt="M-Pesa" width="256" height="145" /></td>
      </tr>
      <tr>
        <td>Purchase your goods via m-pesa </td>
      </tr>
      <tr>
        <td>Our M-pesa Pay Bill No. is: <strong>BTHM5458543NB </strong></td>
      </tr>
      <tr>
      ...
      <tr>
        <td>Enter M-Pesa Transaction No Below </td>
      </tr>
      <tr>
